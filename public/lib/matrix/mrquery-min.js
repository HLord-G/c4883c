...
/* === ./matrix-query-1-0-2.js === */
if (typeof window !== "undefined") {
    if (typeof require === "function" && window.process && window.process.type) {
        // Running in Electron
        window.$ = window.jQuery = require("jquery");
    } else {
        // Running in Browser
        console.log("Running in Browser - jQuery should be loaded via <script> tag.");
    }
}

/* === ./matrix-query-1-0-3.js === */
